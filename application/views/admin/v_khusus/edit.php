      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">v_khusus</li>
          </ul>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-10">
              <div class="card">
                ...
                <div class="card-body">
                  <form class="form-horizontal" action="<?php echo base_url()?>admin/v_khusus/update" method="post">
                  ...
                  ?>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="v_khusus" value="<?php echo $row->variabel ?>">
                      </div>
                    </div>
