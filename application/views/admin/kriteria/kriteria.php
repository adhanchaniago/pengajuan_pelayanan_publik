                    ...
                    <table id="example" class="table table-striped table-sm">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                              <a href="<?php echo base_url()?>admin/kriteria/edit/<?php echo $row->id ?>" class="btn btn-xs btn-info"><i class="fa fa-edit"> </i></a>
                              <a href="<?php echo base_url()?>admin/kriteria/hapus/<?php echo $row->id ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"> </i></a>
                          </td>
                        </tr>
                        <?php $no++;  } ?>
                      </tbody>
      ...
      <div id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url()?>admin/kriteria/simpan" method="post">
                <input type="hidden" name="kode_kriteria" value="<?php echo $kode_kriteria ?>">
                <div class="form-group">
                  <label>Kode Varibel</label>
                  <input type="text" placeholder="" value="<?php echo $kode_kriteria ?>" disabled class="form-control">
                </div>
                <div class="form-group">       
                  <label>Kriteria</label>
                  <input type="text" placeholder="" name="kriteria" class="form-control" autofocus>
                </div>
